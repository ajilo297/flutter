  ...
  CreateCommand({
    ...
    argParser.addOption(
      ...
      allowedHelp: <String, String>{
        ...
        flutterProjectTypeToString(FlutterProjectType.apex): 'Generate starter template for Apex Labs',
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    switch (template) {
      ...
      case FlutterProjectType.skeleton:
        ...
        break;
      case FlutterProjectType.apex:
        generatedFileCount += await generateApp('apex', relativeDir, templateContext, overwrite: overwrite);
        break;
